    	...
    	<div class="container">
        	<div class="row">
            	<div class="col-md-9 col-sm-6 topph">
                    ...
                    <span class="left"><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:info@example.com">info@example.com</a></span>
                </div>
                <div class="col-md-3 col-sm-6">
                	<div class="right">
                	<a class="fifty" href="#"><img src="${pageContext.request.contextPath}/resources/img/eng_1.png" width="15px" height="15px"> English</a>
                    <a class="fifty" href="#"><img src="${pageContext.request.contextPath}/resources/img/arab_flag.png" width="18px" height="15px"> Arabic</a>
                    </div>
                </div>	
            </div>
        </div>
					...
					<div class="col-md-8 modal_body_left modal_body_left1">
						...
						<form action="" method="post" id="id_form_login">
							...
							<input type="hidden" name="groupId" value="2"> <input
								type="button" value="Sign In" class="btn btn-primary"
								id="id_btn_consumer_login"> <input type="button"
